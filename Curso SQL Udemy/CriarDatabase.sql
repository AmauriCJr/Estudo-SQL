...
/* TRIGGERS 
ESQUELETO DE CRIAÇÃO DE TRIGGER:*/
...
/* EXEMPLO - BACKUP PARA OUTRA TABELA*/
...
INSERT INTO USUARIO VALUES(NULL, 'ANDRADE', 'ANDRADE2009','1234');

DELETE FROM USUARIO WHERE IDUSUARIO = 1;

SELECT * FROM BKP_USUARIO;

/* EXEMPLO - BACKUP PARA OUTRO BANCO*/

CREATE DATABASE BACKUP_TESTE;

USE BACKUP_TESTE;

CREATE TABLE BKP_USUARIO_TESTE(
	IDBACKUP INT PRIMARY KEY AUTO_INCREMENT,
	IDUSUARIO INT,
	NOME VARCHAR(30),
	LOGIN VARCHAR(30)
...
INSERT INTO BACKUP_TESTE.BKP_USUARIO_TESTE VALUES(NULL, 1000, 'TESTE','TESTE');
...
FOR EACH ROW
BEGIN
	INSERT INTO BACKUP_TESTE.BKP_USUARIO_TESTE VALUES(NULL, NEW.IDUSUARIO, NEW.NOME, NEW.LOGIN);
END$
DELIMITER ;

/* O USO DE NEW E OLD DEPENDE SE O DADO É NOVO, RECÉM INSERIDO, OU SE É ANTIGO, SE JA ESTAVA PRESENTE NO BANCO */

INSERT INTO USUARIO VALUES(NULL, 'JOHN', 'JOHN2020','1234');

USE BACKUP_TESTE;

SELECT * FROM BKP_USUARIO_TESTE;
...
INSERT INTO PRODUTO VALUES(NULL, 'LIVRO 1', 50.00);
INSERT INTO PRODUTO VALUES(NULL, 'LIVRO 2', 80.00);
INSERT INTO PRODUTO VALUES(NULL, 'LIVRO 3', 70.00);
INSERT INTO PRODUTO VALUES(NULL, 'LIVRO 4', 100.00);
...
INSERT INTO CURSOS VALUES(NULL,'CURSO 1',20,400.00,NULL);
INSERT INTO CURSOS VALUES(NULL,'CURSO 2',40,800.00,1);
INSERT INTO CURSOS VALUES(NULL,'CURSO 3',20,600.00,2);
INSERT INTO CURSOS VALUES(NULL,'CURSO 4',20,400.00,NULL);
INSERT INTO CURSOS VALUES(NULL,'CURSO 5',30,500.00,4);
